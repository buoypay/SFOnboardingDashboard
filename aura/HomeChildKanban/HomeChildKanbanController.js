...
({
    handleRecordUpdated : function(component, event, helper){
        ...
        if(!$A.util.isUndefinedOrNull(currentRec)){
            ...
            var agrFldSecond = recFlds.Summarize_By_Second__c.value;
    ...
    childChanged : function(component, event, helper) {
        ...
        if(data.from != data.to){
            ...
            var sfieldSecond = recFlds.Summarize_By_Second__c.value;
    ...
    deleteRecord : function(component, event, helper) {
        ...
        var sfield = recFlds.Summarize_By__c.value;
        var sfieldSecond = recFlds.Summarize_B_Second__c.value;
